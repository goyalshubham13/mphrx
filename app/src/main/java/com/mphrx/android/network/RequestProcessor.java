...
public class RequestProcessor {
	private static RequestProcessor mInstance;
	...
	public static synchronized RequestProcessor getInstance(Context context) {
		if (mInstance == null) {
			mInstance = new RequestProcessor(context);
		}
		return mInstance;
	}
